...
import com.ghostgamesdhg.minetopia.procedures.dark_spirit.DarkspiritaddedProcedure;
...
public class DarkspiritBlock extends GmmModElements.ModElement {
	@ObjectHolder("gmm:dark_spirit")
	public static final Block block = null;

	public DarkspiritBlock(GmmModElements instance) {
		super(instance, 102);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new BlockItem(block, new Item.Properties().group(MinetopiaExtra.TAB8)).setRegistryName(block.getRegistryName()));
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			DarkspiritaddedProcedure.executeProcedure(Stream
