...
import com.ghostgamesdhg.minetopia.procedures.DevmodepProcedure;
...
public class DevmodeCommand {
	...
	public static void registerCommands(RegisterCommandsEvent event) {
		event.getDispatcher().register(LiteralArgumentBuilder.<CommandSource>literal("devmode")
				...
				.executes(arguments -> {
					...
					DevmodepProcedure.executeProcedure(
