...
public class GmmCommand extends GmmModElements.ModElement {
	public GmmCommand(GmmModElements instance) {
		super(instance, 3);
	...
	private LiteralArgumentBuilder<CommandSource> customCommand() {
		return LiteralArgumentBuilder.<CommandSource>literal("gmm")
	...
	private int execute(CommandContext<CommandSource> ctx) {
		...
		});
		{
			...
			GmmprocedureProcedure.executeProcedure($_dependencies);
		}
		return 0;
	}
}
