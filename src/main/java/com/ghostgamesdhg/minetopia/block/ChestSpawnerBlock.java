...
public class ChestSpawnerBlock extends GMMElements.ModElement {
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Properties.create(Material.ROCK).sound(SoundType.WOOD).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(1)
		...
		public void onBlockAdded(BlockState state, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			world.getPendingBlockTicks().scheduleTick(new BlockPos(x, y, z), this, 10);
			{
				...
				ChestSpawnerBlockAddedProcedure.executeProcedure($_dependencies);
			}
		}
