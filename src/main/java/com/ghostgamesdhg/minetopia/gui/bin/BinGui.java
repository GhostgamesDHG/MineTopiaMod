...
package com.ghostgamesdhg.minetopia.gui.bin;
...
public class BinGui extends GmmModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;
	public BinGui(GmmModElements instance) {
		super(instance, 55);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("bin_gui"));
		}
	}
	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, BinGuiWindow::new));
	}
	...
	public static class GuiContainerMod extends Container implements Supplier<Map<Integer, Slot>> {
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 0, 62, 61) {
			}));
			this.customSlots.put(7, this.addSlot(new SlotItemHandler(internal, 1, 80, 61) {
			}));
			this.customSlots.put(8, this.addSlot(new SlotItemHandler(internal, 2, 98, 61) {
			}));
			int si;
			int sj;
			for (si = 0; si < 3; ++si)
