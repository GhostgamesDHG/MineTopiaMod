...
public class GoldencarrotProcedure extends GmmModElements.ModElement {
	public GoldencarrotProcedure(GmmModElements instance) {
		super(instance, 15);
	}
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		if (dependencies.get("entity") == null) {
			if (!dependencies.containsKey("entity"))
				MinetopiaExtra.LOGGER.warn("Failed to load dependency entity for procedure Goldencarrot!");
			return;
		}
